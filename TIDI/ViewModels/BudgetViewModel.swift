...
class BudgetViewModel: ObservableObject {
    ...
    func loadBudgetCategories(businessIdeaId: Int) {
        isLoading = true
        errorMessage = nil
        
        BudgetService.shared.fetchBudgetCategories(businessIdeaId: businessIdeaId) { result in
    ...
    // For AI answers
    @Published var answers: [BudgetAnswer] = []
    @Published var categoryName: String = ""
    @Published var isLoadingAnswers = false
    @Published var answersErrorMessage: String?
    
    // ai generated answer view model
    func loadAIAnswers(businessIdeaId: Int, budgetCatId: Int) {
        isLoadingAnswers = true
        answersErrorMessage = nil
        
        BudgetService.shared.fetchAIAnswers(businessIdeaId: businessIdeaId, budgetCatId: budgetCatId) { result in
            DispatchQueue.main.async {
    ...
    func fetchTasks(businessIdeaID: Int) {
        ...
        BudgetService.fetchTasks(businessIdeaID: businessIdeaID) { result in
            DispatchQueue.main.async {
    ...
    func completeTask(businessIdeadID: Int, taskID: Int) {
        BudgetService.completeTask(businessIdeadID: businessIdeadID, taskID: taskID) { result in
            DispatchQueue.main.async {
                switch result {
    ...
    func addTask(businessIdeaID: Int, taskDescription: String) {
        ...
        BudgetService.shared.addTask(businessIdeaID: businessIdeaID, taskDescription: taskDescription) { [weak self] result in
            DispatchQueue.main.async {
